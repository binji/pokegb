...
#define FCHK(x,y) OP4F(x)case y:fc=(op==y)||(F&FM[(op-x)/8])==FE[(op-x)/8];
    if (IME&IF&IE) { IF&=~1;halt=IME=0;cy+=8;fc=1;U=64;goto CALLU; }
      ...
      OP7X(0x04) ++(*p);FS(16,!*p,0,!(*p&15),0); break;
      OP7X(0x05) --(*p);FS(16,!*p,1,(*p&15)==15,0); break;
      ...
      case 0x34: u=r(HL)+1;FS(16,!u,0,!(u&15),0);w(HL,u); break;
      case 0x35: u=r(HL)-1;FS(16,!u,1,(u&15)==15,0);w(HL,u); break;
      ...
      ALU(0x88) fc=(F>>4)&1; ADD: u=A+v+fc;FS(0,!u,0,(A&15)+(v&15)+fc>15,A+v+fc>255);A=u; break;
      ALU(0x90) fc=0; goto SUB;
      ALU(0x98) fc=(F>>4)&1; SUB: u=A-v-fc;FS(0,!u,1,(A&15)-(v&15)-fc<0,A-v-fc<0);A=u; break;
      ALU(0xa0) A&=v; FS(0,!A,0,1,0); break;
      ALU(0xa8) A^=v; FS(0,!A,0,0,0); break;
      ALU(0xb0) A|=v; FS(0,!A,0,0,0); break;
      ...
      case 0xcb: switch((op=r8())) {
        case 0x07: fc=(A>>7)&1;A=(A*2)|fc;FS(0,!A,0,0,fc); break;
        case 0x0b: fc=E&1;E=(fc<<7)|(E/2);FS(0,!E,0,0,fc); break;
        case 0x0e: u=r(HL);fc=u&1;u=(fc<<7)|(u/2);FS(0,!u,0,0,fc);w(HL,u); break;
        OP7(0x10) fc=*p>>7;*p=(*p*2)|((F>>4)&1);FS(0,!*p,0,0,fc); break;
        OP7(0x18) fc=*p&1;*p=(*p/2)|((F*8)&128);FS(0,!*p,0,0,fc); break;
        OP7(0x20) fc=(*p>>7)&1;*p*=2; FS(0,!*p,0,0,fc); break;
        case 0x2a: fc=D&1;D=(s8)D>>1; FS(0,!D,0,0,fc); break;
        OP7(0x30) *p=(*p*16)|(*p>>4); FS(0,!*p,0,0,0); break;
        case 0x36: u=r(HL);u=(u*16)|(u>>4); FS(0,!u,0,0,0);w(HL,u); break;
        OP7(0x38) fc=*p&1;*p/=2; FS(0,!*p,0,0,fc); break;
        OP8X(0x46) u=r(HL); goto BITU;
        OP56(0x40) u=*R8[op&7]; BITU: FS(16,!(u&(1<<((op-0x40)/8))),0,1,0); break;
