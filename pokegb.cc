...
(3)*X[f]+=b&8?-1:1;I+=4;        K U(5)U(4)m=b&1;q(a+=1-m*2);D(16,a,m,!(a&15)^m,0        );K U(6)q(i(k++));K M(9)c=*X[f];D(128,1,0,n%4096        +c%4096>4095,n+c>65535);
n+=c;I+=4;K L(7,1)m=1              ;O J;e(32,24)a=i(k++);if(d)k+=(int8_t)a,I+=             4;K P 39:d=a=0;if(F&32||~F&64&&j%15>9)a=6;              if(F&16||~F&64&&j>153
)a|=96,d=1;D(65,j+=F&              64?-a:a,0,0,d);K P 47:j=~j;D(129,1,1,1,0);              K P 55:P 63:D(128,1,0,0,b&8?!(F&16):1);K B              (64)b==118?V=1:q(a);K
  ...
  ~(1<<f),1                                  ,b);K B(     192)q(a|1                                  <<f,1,b);    }K P 224:                                 P 226:P 234
   :P 240:P                                 242:P 250      :c=b&16;q                                (i(b&8?J(      ):65280+(                                b&2?*r:i(
    k++)),j,!c                            ),c,7);K P        233:k=n;K                             P 243:P 251       :A=b!=243;                            K P 248:n=
     w+(int8_t)(                        a=i(k++));D          (0,1,0,(g)w                        +a>255,w%16          +a%16>15);I                        +=4;K P 249
